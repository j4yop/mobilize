export default function Methodology() {
  return (
    <div className="space-y-6">
      <div>
        <div className="eyebrow mb-1">05 — Disclosures</div>
        <h2 className="text-lg font-bold tracking-tight">Methodology</h2>
          ...
          <Section title="Return proxy (the big assumption)">
            <Ul>
              <li>
                ...
                duration approximation: <code className="num">r ≈ y<sub>t−1</sub> − D·(y<sub>t</sub> − y<sub>t−1</sub>)</code>,
